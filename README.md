...
Live Console: <https://aint.aint-app.workers.dev> (health: [`/api/health`](https://aint.aint-app.workers.dev/api/health), telemetry: [`/api/telemetry`](https://aint.aint-app.workers.dev/api/telemetry))
